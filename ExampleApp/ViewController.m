...
//             ];
    ...
    data=@[@{kHACPercentage:@30,  kHACColor    : [UIColor colorWithRed:0.43 green:0.62 blue:0.92 alpha:1.0], kHACCustomText : @"December"},@{kHACPercentage:@45,  kHACColor    : [UIColor colorWithRed:0.44 green:0.66 blue:0.86 alpha:.5], kHACCustomText : @"November"}
            ];
